                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                            data-toggle="modal" href="#addsubject">اضافة مادة</a>
                    </div>
                                        ...
                                        <td>
                                            @if ($subject->id > 0)
                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                    ...
                                                    data-subject_grade="{{ $subject->grade }}"
                                                    data-toggle="modal" href="#editsubject" title="تعديل"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة مادة</h6><button aria-label="Close" class="close" data-dismiss="modal"
                ...
                <div class="modal-body">
                    <form action="{{ route('subject.store') }}" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label class="my-1 mr-2" for="inlineFormCustomSelectPref">المستوي</label>
                            <select name="level" id="level" class="form-control" required>
                                <option value="" selected disabled> --حدد المستوي--</option>
