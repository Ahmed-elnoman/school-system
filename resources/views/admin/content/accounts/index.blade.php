...
@section('content')
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        data-invoice_id="{{ $account->id }}" data-toggle="modal"
                ...
                <div class="modal-body">
                    <form action="{{ route('account.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="section_name" name="price">
                        </div>
    ...
    <div class="modal" id="edtaccount">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">تعديل معاملة</h6><button aria-label="Close" class="close"
                ...
                <div class="modal-body">
                    <form action="{{ route('account.update') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">اسم معلمة</label>
                            <input type="text" class="form-control" id="account_name" name="name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">الوصف</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">المبلغ </label>
                            <input type="number" class="form-control" id="account_price" name="price">
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success">تاكيد</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">اغلاق</button>
