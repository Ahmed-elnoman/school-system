...
@section('content')
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap"
                            ...
                            <tbody>
                                @php
                                    $i = 0;
                                @endphp
                                @foreach ($studentTrashed as $student)
                                    @php
                                        $i++;
                                    @endphp
                                    <tr>
                                        ...
                                        <td>
                                            @if ($student->status == 2)
                                                <span class="text-danger">مفصول</span>
                                            @endif
                                        </td>
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#problme"
                                                        ...
                                                        data-target="#withTrashed"><i
                                                            class="text-warning fas fa-thumbs-up"></i>&nbsp;&nbsp;ارجع
                                                        الطلاب</a>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ارجع التلميذ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <form action="{{ route('student.withTrashed') }}" method="post">
                        @csrf
                </div>
                <div class="modal-body">
                    هل انت متاكد من عملية الارجع ؟
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">حذف التلميذ</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
