...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('teacher.update', $teacher->id) }}" method="post" autocomplete="off"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="teacher_name"
                                        value="{{ $teacher->full_name }}" name="name">
                                </div>
                            </div>

                            <div class="col-3">
                                <img src="{{ $teacher->image }}" alt="" width="50px"
                                    style="margin-top:10px;margin-right:120px;border:2px solid#d2cdcd33">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="test" value="{{ $teacher->phone }}" class="form-control"
                                        id="section_name" name="phone">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="section_name"
                                        value="{{ $teacher->join_date }}" name="join_date">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="section_name"
                                        value="{{ $teacher->salary }}" name="salary" value="{{ old('salary') }}">
                                </div>
                            </div>
