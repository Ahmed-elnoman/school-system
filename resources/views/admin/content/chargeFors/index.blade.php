...
@section('content')
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">الرسوم(المبلغ)</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة رسوم</h6><button aria-label="Close" class="close" data-dismiss="modal"
                ...
                <div class="modal-body">
                    <form action="{{ route('charge.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="charge_price" name="charge_price">
                        </div>
    ...
    <div class="modal" id="editclassroom">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">تعديل الرسوم</h6><button aria-label="Close" class="close" data-dismiss="modal"
                        type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
