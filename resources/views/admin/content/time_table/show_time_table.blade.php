            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a data-effect="effect-scale"  data-toggle="modal" href="#addsubject"
                        ...
                        اضافة </a>
                        <a data-effect="effect-scale" href="{{route('time.print', $classname->name)}}"
                        class="modal-effect btn btn-sm btn-danger" style="color:white"><i class="mdi mdi-printer ml-1"></i>&nbsp;
                        طباعة الجدول </a>
                ...
                <div class="modal-body">
                    <form action="{{ route('time.store') }}" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="class_name" class="form-control" readonly value="{{$classname->name}}" id="">
                        </div>
                        <div class="form-group">
