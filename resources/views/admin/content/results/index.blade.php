        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-3">
                    ...
                    <div class="row">
                        <div class="col-2 col-sm-2 col-md-2 mb-2 mt-3">
                            <div class="form-group">
                                <!-- new retsutl collapse  !-->
                                <label class="ckbox"><input type="checkbox" aria-expanded="true" data-toggle="collapse"
                                        href="#multiCollapseExample1"><span>جديدة</span>
                                </label>
                            </div>
                        </div>
                        <div class="col-2 col-sm-2 col-md-2 mb-2 mt-3">
                            <div class="form-group">
                                <!-- retsutl exits collapse  !-->
                                <label class="ckbox"><input type="checkbox" aria-expanded="true" data-toggle="collapse"
                                        href="#collapseOne2"><span>موجودة مسبقا</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <!-- start new retsutl collapse  !-->
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <form class="coupon-form" action="{{ route('result.search.new') }}" method="GET">
                    ...
                    <!-- end new retsutl collapse  !-->
                    <!-- start retsutl exits collapse  !-->
                    <div aria-multiselectable="false" class="accordion accordion-dark" id="accordion2" role="tablist">
                        <div class="card mb-0">
                            <div aria-labelledby="headingOne2" class="collapse" data-parent="#accordion2" id="collapseOne2"
                                role="tabpanel">
                                <form class="coupon-form" action="{{ route('time.show') }}" method="GET">
                                    <select name="class_name" class="form-control" required>
                                        <option value="" selected disabled> --حدد الصف--</option>
                                        @foreach ($classRooms as $room)
                                            <option value={{ $room->id }}>{{ $room->name }}</option>
