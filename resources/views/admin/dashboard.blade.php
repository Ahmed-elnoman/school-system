...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            ...
            <div>
                <label class="tx-13">اجمالي عدد الطلاب</label>
                <h5>{{ App\Models\Student::all()->count() }}</h5>
            </div>
            <div>
                <label class="tx-13">اجمالي عدد المعلمين</label>
                <h5>{{ App\Models\Teacher::all()->count() }}</h5>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                <div class="card overflow-hidden sales-card bg-success-gradient">
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        <div class="">
                            <h6 class="mb-3 tx-12 text-white">اسم الفصل : {{ $class->name }}</h6>
                        </div>
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white">السعة الفصل : {{ $class->capacity }}
                                    </h4>
                                    <p class="mb-0 tx-12 text-white op-7">عدد الطلاب {{ $class->level }}</p>
                                </div>
                                <span class="float-right my-auto mr-auto">
                                    <i class="fas fa-arrow-circle-up text-white"></i>
                                    <span class="text-white op-7"> {{ $class->student_count }}</span>
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row row-sm row-deck">
        <div class="col-md-12 col-lg-4 col-xl-4">
            <div class="card card-dashboard-eight pb-2">
                <h6 class="card-title">الاول</h6><span class="d-block mg-b-10 text-muted tx-12">Sales
