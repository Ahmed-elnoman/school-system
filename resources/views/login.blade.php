...
@section('title')
تسجيل دخول - برنامج نظام المدرسة
@stop
                        ...
                        <div class="row">
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    {{-- <div class="mb-5 d-flex"> <a href="{{ url('/' . $page='Home') }}"><img src="{{URL::asset('assets/img/media/samsung-watch-4.png')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Mic<span>ro</span>lab</h1></div> --}}
                                    <div class="card-sigin">
